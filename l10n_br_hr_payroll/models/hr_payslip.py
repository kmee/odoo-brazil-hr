...
class HrPayslip(models.Model):
    ...
    total_folha = fields.Float(string="Total", default=0.00)
...
class HrPayslipeLine(models.Model):
    ...
    def _valor_deducao(self):
        for record in self:
            if record.salary_rule_id.category_id.code in \
                    ["DEDUCAO"] or record.salary_rule_id.code == "INSS" or \
                            record.salary_rule_id.code == "IRPF":
